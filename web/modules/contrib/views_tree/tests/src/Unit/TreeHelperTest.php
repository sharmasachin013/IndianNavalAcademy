...
class TreeHelperTest extends UnitTestCase {
   ...
   */
  protected ViewsResultTreeValues $viewsResultTree;
   ...
   */
  public function testGetTreeFromResultFromEmptyResult(): void {
   ...
   * @covers ::getTreeFromResult
   */
  public function testGetTreeFromResultWithNoHierarchy(): void {
    $tree_helper = new TreeHelper($this->viewsResultTree);
    $tree_data = [];
   ...
   * @covers ::getTreeFromResult
   */
  public function testGetTreeFromResultWithOneLevelHierarchy(): void {
    $tree_helper = new TreeHelper($this->viewsResultTree);
    $tree_data = [];
    $tree_data[] = new ResultRow([
      'views_tree_main' => 1,
   ...
   * @covers ::getTreeFromResult
   */
  public function testGetTreeFromResultWithMultipleLevelHierarchy(): void {
    $tree_helper = new TreeHelper($this->viewsResultTree);
    $tree_data = [];
    $tree_data[] = new ResultRow([
      'views_tree_main' => 1,
   ...
   */
  public function testApplyFunctionToTree(): void {
    $tree = new TreeItem(1);
   ...
   * @covers ::applyFunctionToTree
   */
  public function testApplyFunctionToTreeWithNulls(): void {
